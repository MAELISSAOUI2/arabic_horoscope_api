...
headers = {"Authorization": f"Bearer {settings.KONNECT_API_KEY}", "Content-Type": "application/json"}
...
"""
# event example: {"type":"checkout.session.completed","data":{"customer_email":"a@b.c","status":"active","period_end":"2025-09-29T00:00:00Z"}}
